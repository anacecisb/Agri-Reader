...
public:
    ...
    QCheckBox *checkBoxNormalizeDisplay;
    QCheckBox *checkBoxApplyDarkCorrection;
    ...
    QLabel *label_7;
    QLineEdit *textBoxHeaterTarget;
    QPushButton *buttonGetHeaterTarget;
    QPushButton *buttonSetHeaterTarget;
    ...
    QListWidget *listWidgetResultsBrowser;
    QMenuBar *menuBar;
    QMenu *menuQuickChis;
    ...
    void setupUi(QMainWindow *QuickChipsMainWindow)
    {
        ...
        textBoxExposure->setGeometry(QRect(130, 120, 101, 22));
        ...
        buttonExposureGet->setGeometry(QRect(240, 120, 41, 21));
        ...
        buttonCaptureDark->setGeometry(QRect(240, 30, 91, 31));
        ...
        buttonClearDark->setGeometry(QRect(240, 70, 91, 31));
        ...
        textBoxCameraTickRate->setGeometry(QRect(130, 150, 101, 22));
        ...
        buttonCameraTickRateGet->setGeometry(QRect(240, 150, 41, 21));
        ...
        buttonCameraTickRateSet->setGeometry(QRect(290, 150, 41, 21));
        ...
        checkBoxNormalizeDisplay = new QCheckBox(groupBox);
        checkBoxNormalizeDisplay->setObjectName(QStringLiteral("checkBoxNormalizeDisplay"));
        checkBoxNormalizeDisplay->setGeometry(QRect(30, 70, 191, 20));
        checkBoxNormalizeDisplay->setChecked(true);
        checkBoxApplyDarkCorrection = new QCheckBox(groupBox);
        checkBoxApplyDarkCorrection->setObjectName(QStringLiteral("checkBoxApplyDarkCorrection"));
        checkBoxApplyDarkCorrection->setGeometry(QRect(30, 90, 171, 20));
        checkBoxApplyDarkCorrection->setChecked(true);
        groupBox_2 = new QGroupBox(centralWidget);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setEnabled(true);
        groupBox_2->setGeometry(QRect(990, 530, 261, 101));
        buttonBTSend = new QPushButton(groupBox_2);
        buttonBTSend->setObjectName(QStringLiteral("buttonBTSend"));
        buttonBTSend->setGeometry(QRect(140, 60, 111, 31));
        textBoxBTDBG = new QLineEdit(groupBox_2);
        textBoxBTDBG->setObjectName(QStringLiteral("textBoxBTDBG"));
        textBoxBTDBG->setGeometry(QRect(60, 30, 191, 22));
        label_2 = new QLabel(groupBox_2);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 30, 61, 21));
        groupBox_3 = new QGroupBox(centralWidget);
        groupBox_3->setObjectName(QStringLiteral("groupBox_3"));
        groupBox_3->setGeometry(QRect(10, 200, 341, 141));
        ...
        label_7->setGeometry(QRect(10, 110, 151, 21));
        label_7->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        textBoxHeaterTarget = new QLineEdit(groupBox_3);
        textBoxHeaterTarget->setObjectName(QStringLiteral("textBoxHeaterTarget"));
        textBoxHeaterTarget->setGeometry(QRect(170, 110, 61, 22));
        buttonGetHeaterTarget = new QPushButton(groupBox_3);
        buttonGetHeaterTarget->setObjectName(QStringLiteral("buttonGetHeaterTarget"));
        buttonGetHeaterTarget->setGeometry(QRect(240, 110, 41, 21));
        sizePolicy.setHeightForWidth(buttonGetHeaterTarget->sizePolicy().hasHeightForWidth());
        buttonGetHeaterTarget->setSizePolicy(sizePolicy);
        buttonSetHeaterTarget = new QPushButton(groupBox_3);
        buttonSetHeaterTarget->setObjectName(QStringLiteral("buttonSetHeaterTarget"));
        buttonSetHeaterTarget->setGeometry(QRect(290, 110, 41, 21));
        sizePolicy.setHeightForWidth(buttonSetHeaterTarget->sizePolicy().hasHeightForWidth());
        buttonSetHeaterTarget->setSizePolicy(sizePolicy);
        ...
        groupBox_9->setGeometry(QRect(10, 350, 341, 391));
        ...
        listWidgetProcessInstructions->setGeometry(QRect(10, 90, 321, 301));
        ...
        groupBox_4->setGeometry(QRect(990, 630, 261, 101));
        buttonDebugB = new QPushButton(groupBox_4);
        buttonDebugB->setObjectName(QStringLiteral("buttonDebugB"));
        buttonDebugB->setGeometry(QRect(70, 60, 181, 31));
        buttonDebugA = new QPushButton(groupBox_4);
        buttonDebugA->setObjectName(QStringLiteral("buttonDebugA"));
        buttonDebugA->setGeometry(QRect(140, 20, 111, 31));
        groupBox_10 = new QGroupBox(centralWidget);
        groupBox_10->setObjectName(QStringLiteral("groupBox_10"));
        groupBox_10->setGeometry(QRect(600, 530, 381, 211));
        listWidgetResultsBrowser = new QListWidget(groupBox_10);
        listWidgetResultsBrowser->setObjectName(QStringLiteral("listWidgetResultsBrowser"));
        listWidgetResultsBrowser->setGeometry(QRect(10, 30, 361, 171));
    ...
    void retranslateUi(QMainWindow *QuickChipsMainWindow)
    {
        ...
        checkBoxNormalizeDisplay->setText(QApplication::translate("QuickChipsMainWindow", "Normalize Display Image", 0));
        checkBoxApplyDarkCorrection->setText(QApplication::translate("QuickChipsMainWindow", "Apply Dark Correction", 0));
        ...
        label_7->setText(QApplication::translate("QuickChipsMainWindow", "Heater Target (centi C)", 0));
        buttonGetHeaterTarget->setText(QApplication::translate("QuickChipsMainWindow", "Get", 0));
        buttonSetHeaterTarget->setText(QApplication::translate("QuickChipsMainWindow", "Set", 0));
        ...
        groupBox_8->setTitle(QApplication::translate("QuickChipsMainWindow", "Recent Results", 0));
        ...
        groupBox_10->setTitle(QApplication::translate("QuickChipsMainWindow", "Results Browser", 0));

...
#include "../QuickChips/IVDCore/roimanager.h"
...
const QMetaObject ROIManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ROIManager.data,
      qt_meta_data_ROIManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ROIManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ROIManager.stringdata0))
        return static_cast<void*>(const_cast< ROIManager*>(this));

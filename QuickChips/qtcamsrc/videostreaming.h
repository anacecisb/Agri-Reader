...
class  Videostreaming : public QObject, public v4l2
{
    Q_OBJECT
public:
    struct buffer {
...
private:
    ...
    __u32 m_pixelformat;
public: // alh i need this to make my own raw buffer (properly)
...
private:
    ...
    // alh, public this to get exposure setting....
public:
...
public slots:
    ...
    /**
     * @brief IVD CUNIR12 specific request for raw Y16 data
     *  -
     */
    bool capRawY16Frame( unsigned char* returnBuffer );


    QPixmap* convertRawY16Frame(unsigned char *rawBuffer);
